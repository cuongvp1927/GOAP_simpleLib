...
public class GoToRestaurant : CActionBase
{
    ...
    public override bool Pre_Perform()
    {
        ...
        LocationInformation loc = infor.infos.Find(e => e.codeName.Equals("Restaurant"));
        ...
        Debug.LogError("Can not find position of the location: Restaurant");
        return false;
    }
